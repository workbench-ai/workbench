...
- `packages/built-in-adapters`: built-in command, rubric, Codex, and Claude adapters
...
- `packages/agent-driver*`: first-party agent driver packages used by built-in agent adapters
