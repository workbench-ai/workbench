...
- Include a DOCX parser such as `python-docx` or an equivalent when the subject runner or scoring helper needs to inspect text, headings, tables, headers, footers, comments, or styles.
