...
- Include a DOCX parser such as `python-docx` or an equivalent when the candidate runner or scoring helper needs to inspect text, headings, tables, headers, footers, comments, or styles.
...
- Layout-sensitive cases should verify that the output opens and renders with the intended toolchain.
